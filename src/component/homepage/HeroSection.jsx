...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <motion.h1
          className="text-4xl sm:text-6xl font-bold text-gray-900 mt-20"
          variants={item}
        >
          Find Your Ideal <span className="text-red-600">Life Partner</span>
        </motion.h1>
        ...
        <motion.p
          className="mt-4 text-xl text-gray-600 max-w-[90vh] items-center mx-auto"
          variants={item}
        >
          Connect with compatible Muslims in a safe, respectful environment
          designed for serious matrimonial intentions.
        ...
        >
          <Link
            href="/register"
            className="bg-red-600 text-white text-lg px-7 py-2 rounded-md font-semibold hover:bg-red-700 transition"
          >
            Sign Up Today
          </Link>
          <button
        ...
        <motion.div
          className="mt-10 flex flex-col sm:flex-row justify-center gap-6 text-sm text-gray-700"
          variants={item}
        >
          <div className="flex items-center gap-2">
            <span>⏱️</span>
